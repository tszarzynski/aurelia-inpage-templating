        ...
        execute: function () {
            ...
            TextTemplateLoader.prototype.loadTemplate = function (loader, entry) {
                return loader.loadText(entry.address).then(function (text) {
                    var template = entry.template = DOM.createTemplateFromMarkup(text);
            ...
            _export('InpageTemplatingResources', InpageTemplatingResources = (_dec = inject(ViewResources, Container), _dec(_class = function () {
            ...
            _export('InpageTemplatingResources', InpageTemplatingResources);
        }
    };
});